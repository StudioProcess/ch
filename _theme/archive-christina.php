   ...
   <main role="main">
      ...
      <?php if ( !post_password_required(766) ) : ?>
         ...
         <?php if (have_posts()): while (have_posts()) : the_post();
   			?><!-- article --><article id="<?php the_ID(); ?>" data-slug="<?php echo $post->post_name; ?>" data-menu-order="<?php echo $post->menu_order; ?>" <?php post_class('gallery'); ?> <?php echo ch_margins()->style; ?>>
   				<?php if (!ch_is_teaser()): ?>
   				<!-- post title -->
   				<h2>
