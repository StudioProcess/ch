...
function ch_inject_teaser( $posts, $q ) {
	/* add this to if block to show teaser in weddings archiveagain: || $q->is_post_type_archive('christina') */
	if ( $q->is_main_query() && ($q->is_post_type_archive('gallery') || $q->is_category()) ) {
